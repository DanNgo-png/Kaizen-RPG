export const UNDEAD_FACTION_CONFIG = Object.freeze({
    ...
    INVASION_CHANCE: 0.18,       // 18% daily chance for normal crypts to launch immediate surprise attacks
    SIEGE_CHANCE: 0.10,          // 10% daily chance for Necromancers to gather armies and siege
