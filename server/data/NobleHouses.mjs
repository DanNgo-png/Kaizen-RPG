...
export const NOBLE_HOUSE_LORE_POOL = Object.freeze([
    {
        ...
        color: "#22c55e",
        archetype: NOBLE_HOUSE_ARCHETYPES.OLD_BLOOD,
        motto: "Roots deeper than steel.",
        seatName: "Blackwood Hold",
        capitalType: "Stronghold"
    },
    {
        name: "House Sterling",
        color: "#fbbf24",
        archetype: NOBLE_HOUSE_ARCHETYPES.MERCHANT,
        motto: "Prosperity binds the realm.",
        seatName: "Sterlingport",
        capitalType: "City"
    },
    {
        name: "House Veyr",
        color: "#60a5fa",
        archetype: NOBLE_HOUSE_ARCHETYPES.SCHOLARLY,
        motto: "Wisdom before conquest.",
        seatName: "Veyrspire",
        capitalType: "City"
    },
    {
        ...
        color: "#ef4444",
        archetype: NOBLE_HOUSE_ARCHETYPES.MILITARISTIC,
        motto: "The border does not break.",
        seatName: "Thornwatch Keep",
        capitalType: "Stronghold"
    },
    {
        name: "House Emberfall",
        color: "#f97316",
        archetype: NOBLE_HOUSE_ARCHETYPES.FRONTIER,
    ...
    },
    {
        ...
        color: "#94a3b8",
        archetype: NOBLE_HOUSE_ARCHETYPES.MILITARISTIC,
        motto: "Iron answers all.",
        seatName: "Ironvale Bastion",
        capitalType: "Stronghold"
    },
    {
        name: "House Mirecrest",
        color: "#14b8a6",
        archetype: NOBLE_HOUSE_ARCHETYPES.MERCHANT,
        motto: "Every road pays its due.",
        seatName: "Mirecrest",
        capitalType: "City"
    }
]);
